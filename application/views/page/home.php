...
<head>
	<meta charset="utf-8" />
	<title>Ngelondri | Aplikasi Laundry Cepat</title>
	<base href="<?=base_url()?>"></base>
	<meta name="description" content="app, web app, responsive, admin dashboard, admin, flat, flat ui, ui kit, off screen nav" />
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" /> 
	<link rel="stylesheet" href="aset/page/css/bootstrap.css" type="text/css" />
	<link rel="stylesheet" href="aset/page/css/animate.css" type="text/css" />
	<link rel="stylesheet" href="aset/page/css/font-awesome.min.css" type="text/css" />
	<link rel="stylesheet" href="aset/page/css/font.css" type="text/css" />
	<link rel="stylesheet" href="aset/page/css/landing.css" type="text/css" />
	<link rel="stylesheet" href="aset/page/css/app.css" type="text/css" />
  <!--[if lt IE 9]>
...
<body>
	...
	<header id="header" class="navbar navbar-fixed-top bg-white box-shadow b-b b-light"  data-spy="affix" data-offset-top="1">
		<div class="container">
			<div class="navbar-header">        
				<a href="#" class="navbar-brand"><img src="aset/page/images/logo.png" class="m-r-sm"><span class="text-muted">Notebook</span></a>
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li>
						<a href="index.php#about">Layanan</a>
					</li>
					<li>
			...
			<div class="text-center wrapper">
				<div class="m-t-xl m-b-xl">
					<div class="text-uc h1 font-bold inline">
						<div class="pull-left m-r-sm text-white">Ngelondri <span class="font-thin text-muted">|</span></div>
					...
					<div class="h4 text-muted m-t-sm">Aplikasi Laundry Cepat</div>
				</div>
				...
				<div class="hbox">
							...
							<section class="panel bg-dark inline m-b-n-lg m-r-n-lg aside-sm no-border device phone animated fadeInLeftBig">
								...
								<div>
									<div class="m-l-xs m-r-xs">
										<img src="aset/page/images/phone-2.png" class="img-full" >
									</div>
								</div>
							</section>
						</div>
					...
					<aside class="col-sm-10 col-md-6">
						<section class="panel bg-dark m-b-n-lg no-border device animated fadeInUp">
							...
							<img src="aset/page/images/main.png" class="img-full" >
						</section>
					</aside>
					<aside class="col-md-3 v-bottom">
						<div class="hidden-sm hidden-xs">
							<section class="panel bg-light m-b-n-lg m-l-n-lg aside no-border device phone animated fadeInRightBig">
								...
								<div class="">
									<div class="m-l-xs m-r-xs">
										<img src="aset/page/images/phone-1.png" class="img-full" >
									</div>
								</div>
							</section>
						</div>
	...
	<!-- footer -->
	<footer>
		<div class="bg-primary text-center" id="download">
			<div class="container wrapper">
		...
		<div class="bg-dark dker wrapper" id="footer">
			<div class="container text-center m-t-lg">
				...
				<div class="m-t-xl m-b-xl">
					...
					<p>
						<a href="index.php#" data-jump="true" class="btn btn-icon btn-rounded btn-dark b-dark bg-empty m-sm text-muted"><i class="fa fa-angle-up"></i></a>
					</p>
				</div>
			</div>
		</div>
	...
	<!-- / footer -->  
	<script src="aset/page/js/jquery.min.js"></script>
	<!-- Bootstrap -->
	<script src="aset/page/js/bootstrap.js"></script>
	<!-- App -->
	<script src="aset/page/js/app.js"></script>
	<script src="aset/page/js/app.plugin.js"></script>
	<script src="aset/page/js/slimscroll/jquery.slimscroll.min.js"></script>

	<script src="aset/page/js/appear/jquery.appear.js"></script>
	<script src="aset/page/js/scroll/smoothscroll.js"></script>
	<script src="aset/page/js/landing.js"></script>
